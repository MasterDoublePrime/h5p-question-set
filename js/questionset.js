...
H5P.QuestionSet = function (options, contentId) {
  ...
  if (params.override !== undefined && (params.override.showSolutionButton || params.override.retryButton)) { /*Modified by SUPRIYA RAJGOPAL on 28Jul16 to prevent 'Cannot read property showSolutionButton of undefined' error*/
    override = {};
